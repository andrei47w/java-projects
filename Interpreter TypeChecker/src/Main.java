...
public class Main {
    public static void CommandRun() {
        ...
        PrgState prg6 = new PrgState(new CompStmt( new DeclStmt("v", new IntType()),
...
//                                                                                new PrintStmt(new HeapReadExp(new VariableExp("a")))))))))))));
        ...
        Controller ctr6 = new Controller(new Repo("logs/log6.txt"));
        ctr6.addProgramState(prg6);

        PrgState prg7 = new PrgState(new CompStmt(new DeclStmt("v", new RefType(new IntType())),
                new CompStmt(new HeapAllocStmt("v", new ValueExp(new IntValue(20))),
                        new CompStmt(new DeclStmt("a", new RefType(new RefType(new IntType()))),
                                new CompStmt(new HeapAllocStmt("a", new VariableExp("v")),
                                        new CompStmt(new PrintStmt(new HeapReadExp(new VariableExp("v"))),
                                                new PrintStmt(new ArithExp(
                                                        ArithOp.ADDITION,
                                                        new HeapReadExp(new HeapReadExp(new VariableExp("a"))),
                                                        new ValueExp(new IntValue(5))
                                                        ))))))));

        Controller ctr7 = new Controller(new Repo("logs/log6.txt"));
...
//        menu.addCommand(new RunExample("5", prg5.toString(), ctr5));
        menu.addCommand(new RunExample("6", prg6.toString(), ctr6));
//        menu.addCommand(new RunExample("7", prg7.toString(), ctr7));
        menu.show();
    }
