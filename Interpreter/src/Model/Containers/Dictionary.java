...
//            throw new MyException("Key not found " + key + " aka " + key.getClass().toString() + " in " + this.Map.getClass().toString() + " from: " + this.Map.keySet().iterator().next().getClass().toString() + " and  " + this.Map.entrySet().iterator().next().getClass().toString());
//        }
        try {
            return Map.get(key);
        }catch(Exception e) {
